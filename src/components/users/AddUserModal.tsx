                ...
                <div className="p-4 bg-indigo-50/50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-800/50 rounded-2xl space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2 space-y-1.5">
                      <label htmlFor="add-emergencyName" className="text-xs font-bold text-slate-700 dark:text-slate-300">
                        Nama Kontak Darurat
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div className="space-y-1.5">
                      <label htmlFor="add-emergencyRelation" className="text-xs font-bold text-slate-700 dark:text-slate-300">
                        Hubungan
                      </label>
                      <input
                        id="add-emergencyRelation"
