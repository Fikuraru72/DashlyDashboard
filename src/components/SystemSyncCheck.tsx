    ...
    <div className="sync-card">
      ...
      <div className="sync-header">
        ...
        <div>
          ...
          <p className="sync-subtitle">Verify Backend · Database · Network are all reachable</p>
        </div>
      </div>
      ...
      <div className={`sync-status-bar ${statusColors[state]}`}>
        ...
        {latencyMs !== null && <span className="sync-latency">{latencyMs} ms</span>}
      </div>
      ...
      {state === "success" && result && (
        <div className="sync-result-grid">
          ...
          <ResultRow
            icon="🕐"
            label="Server Time"
            value={new Date(result.serverTime).toLocaleString()}
            fullWidth
          />
        </div>
      )}
