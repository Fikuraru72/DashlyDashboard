...
export default function PublicEventMonitoringPage() {
  ...
  // ensuring marker element visual updates (anomaly badge, color, status) appear
  // at the exact moment the marker arrives at that coordinate.
  const handleWaypointConsumed = useCallback((userId: string, wp: import("@/hooks/useMapMarkerAnimation").TelemetryWaypoint) => {
    ...
    const stateKey = `${wp.displayName}_${wp.status}_${wp.isStale}_${wp.isAnomaly}_${wp.color}`;
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      // Add Native WebGL Participants Source (Unified 3D Ground Alignment)
          ...
          setParticipants((prev) => {
            ...
            newParticipants.forEach(({ data, lat, lng }, userId) => {
              ...
              next.set(userId, {
                ...
                lng,
                routeIndex:
                  data.routeIndex !== undefined && data.routeIndex !== null
                    ? parseInt(data.routeIndex)
                    : current.routeIndex,
                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        {p.hasAlert && (
                          <span className="text-[9px] font-black text-rose-600 animate-pulse uppercase shrink-0">
                            🚨 ALERT
                          </span>
                        )}
                      </div>
